...
func TestNewLogger(t *testing.T) {
	...
	for _, tc := range []testCase{
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			logger = logger.WithName("sfa-dips").WithName("api").WithName("")
...
func TestNewLoggerWithDebug(t *testing.T) {
	...
	logger = logger.WithName("sfa-dips.api.test")
	...
	assert.Assert(t, cmp.Contains(s, `service.name=sfa-dips.api.test`))
